...
const column=[{title:'DISCOM',dataIndex:'discom'},{title:'YEAR_MONTH',dataIndex:'year_month'},{title:'Power Failure Occurrence Event Duration',dataIndex:'power_failure_occurrence_event_duration'},{title:'Consumer Count',dataIndex:'consumer_count'},{title:'CAIDI',dataIndex:'data'}]
