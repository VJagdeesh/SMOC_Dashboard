...
<>
    ...
    <div className="row mt-3">
      <div className="col-lg-3">
          <Select placeholder="State " required options={stateoptions} onChange={(e)=>{setstate(e[0].label)}} style={{background:"white"}}/>
      </div>
      ...
      <div className="col-lg-3 form-group">
          <input  type="month" required min="2018-07" max = "2024-12" className="form-control " onChange={(e)=>{setfromdate(e.target.value)}}/>
      </div>
    ...
    <div className="row mt-3">
      ...
      <button type="button" className="btn btn-secondary px-5 reset-btn" onClick={resetHandler}>Reset</button>
      </div>
    </div>
    </form>
</>
